        ...
        for update in updates {
            ...
            clear_error(match update.update_type {
                UpdateType::Message(Message {
                    ...
                    parser::parse_message(&client, conn, name, user, id, data, chat, webapp_url)
                        .await
                }
                ...
                UpdateType::ChosenInlineResult(ChosenInlineResult { ref result_id, .. }) => {
                    parser::parse_inline_query_response(&client, conn, user, result_id, webapp_url)
                        .await
                }
                UpdateType::CallbackQuery(CallbackQuery {
                    ...
                    parser::parse_callback_query(&client, conn, user, msg, data, webapp_url).await
                }
                _ => {
